...
<a href="./index.php?view=newticket" class="btn btn-info">Nuevo Caso</a>
<br><br>
  ...
  <div class="form-group">
    <div class="col-lg-2">
		<div class="input-group">
		  ...
		  <input type="text" name="q" value="<?php if(isset($_GET["q"]) && $_GET["q"]!=""){ echo $_GET["q"]; } ?>" class="form-control" placeholder="Buscar nombre">
		</div>
    </div>
    <div class="col-lg-2">
		<div class="input-group">
  ...
  <?php endforeach; ?>
    ...
    <div class="col-lg-4">
		<div class="input-group">
		  ...
		  <input type="date" name="date_at" value="<?php if(isset($_GET["date_at"]) && $_GET["date_at"]!=""){ echo $_GET["date_at"]; } ?>" class="form-control" placeholder="Buscar por fecha (aaaa-mm-dd)">
		</div>
    </div>
...
if($_GET["q"]!=""||$_GET["project_id"]!="" ||$_GET["category_id"]!="" ){
	...
	$sql .= " date(created_at) = \"".$_GET["date_at"]."\"";
		...
		if(count($users)>0){
			...
			echo "<p class='alert alert-danger'>No hay </p>";
		}
