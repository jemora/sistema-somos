...
<div class="card">
  <div class="card-header" data-background-color="blue">
      <h4 class="title">Reporte de Casos Pendientes</h4>
  </div>
  <div class="card-content table-responsive">


<form class="form-horizontal" role="form">
<input type="hidden" name="view" value="reports1">
<?php
...
$sql = "select * from ticket where status_id = '1'";
		...
		if(count($users)>0){
			...
			echo "<p class='alert alert-danger'>No hay casos</p>";
		}
